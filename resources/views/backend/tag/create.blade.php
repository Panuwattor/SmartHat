...
<form id="app" v-cloak action="/admin/tag/store" method="post" enctype="multipart/form-data" onsubmit="return confirm('ยืนยันเพิ่มผลงานของเรา ?')">
    @csrf
    <div class="row">
                    ...
                    <table class="table table-hover text-nowrap text-center">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in arr">
                                <td>@{{index + 1}}</td>
                                <td>
                                    <input required type="text" name="name[]" class="form-control form-control-sm" autocomplete="0ff" placeholder="ชื่อแท็ก">
                                </td>
                                <td>
