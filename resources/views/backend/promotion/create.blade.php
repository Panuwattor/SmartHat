...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">เพิ่มโปรโมชั่น</h1>
            </div>
            <div class="col-sm-6">
...
<form id="app" v-cloak action="/admin/promotion/store" method="post" enctype="multipart/form-data" onsubmit="return confirm('ยืนยันเพิ่ม ?')">
    @csrf
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">Details <code>*</code></label>
                    ...
                    <div class="form-group">
                        <label for="">File <code>*</code></label>
                        <input type="file" name="file" class="form-control form-control-sm" autocomplete="off" required>
                    </div>
                </div>
